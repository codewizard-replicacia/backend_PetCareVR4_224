...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("PetCareVR4", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareVR4/PetServices?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/PetCareVR4/PetServices/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareVR4/PetOwners?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareVR4/PetOwners/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePetCareCenterInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCareVR4/PetCareCenters")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareVR4/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareVR4/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareVR4/BusinessHours?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareVR4/BusinessHours/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareVR4/Documents?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareVR4/Documents/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM petcarevr.PetService");
    jdbcTemplate.execute("DELETE FROM petcarevr.PetOwner");
    jdbcTemplate.execute("DELETE FROM petcarevr.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM petcarevr.BusinessHours");
    jdbcTemplate.execute("DELETE FROM petcarevr.Document");
    jdbcTemplate.execute("DELETE FROM petcarevr.Pet");
     jdbcTemplate.execute("DELETE FROM petcarevr.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM petcarevr.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM petcarevr.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM petcarevr.PetCareCenterPets");
